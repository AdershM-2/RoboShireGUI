#!/usr/bin/env python3
"""
imu_sensor - Generated by RobotStudio
...
class ImuSensorNode(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info('imu_sensor starting...')
        ...
        self.get_logger().info('imu_sensor initialized successfully')
...
def main(args=None):
    ...
    try:
        ...
        node.get_logger().info('imu_sensor shutting down')
        node.destroy_node()
