#!/usr/bin/env python3
"""
light_sensor - Generated by RobotStudio
...
class LightSensorNode(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info('light_sensor starting...')
        ...
        self.get_logger().info('light_sensor initialized successfully')
...
def main(args=None):
    ...
    try:
        ...
        node.get_logger().info('light_sensor shutting down')
        node.destroy_node()
