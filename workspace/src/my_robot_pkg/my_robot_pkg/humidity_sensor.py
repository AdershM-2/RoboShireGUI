#!/usr/bin/env python3
"""
humidity_sensor - Generated by RobotStudio
...
class HumiditySensorNode(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info('humidity_sensor starting...')
        ...
        self.get_logger().info('humidity_sensor initialized successfully')
...
def main(args=None):
    ...
    try:
        ...
        node.get_logger().info('humidity_sensor shutting down')
        node.destroy_node()
