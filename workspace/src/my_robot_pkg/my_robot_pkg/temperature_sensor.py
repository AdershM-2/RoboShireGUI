#!/usr/bin/env python3
"""
temperature_sensor - Generated by RobotStudio
...
class TemperatureSensorNode(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info('temperature_sensor starting...')
        ...
        self.get_logger().info('temperature_sensor initialized successfully')
...
def main(args=None):
    ...
    try:
        ...
        node.get_logger().info('temperature_sensor shutting down')
        node.destroy_node()
