#!/usr/bin/env python3
"""
serial_bridge - Generated by RobotStudio
...
class SerialBridgeNode(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info('serial_bridge starting...')
        ...
        self.get_logger().info('serial_bridge initialized successfully')
...
def main(args=None):
    ...
    try:
        ...
        node.get_logger().info('serial_bridge shutting down')
        node.destroy_node()
